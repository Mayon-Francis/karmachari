...
import EditStudentProfileModal from "@/components/EditStudentProfileModal/EditStudentProfileModal";
...
const StudentDashboard = () => {
  ...
  //hook for ButtonGroup
  const [isStatus, setSelection] = useState(false);
  ...
  return (
    <>
      <CustomTitle title="Student Profile" />
      <div className={styles.my_profile_container}>
          ...
          <div className={styles.profile_details_container}>
            ...
            <div className={styles.phone_class}>
              ...
              <div className={styles.profile_phone}>
                ...
                <div>{userData.parent_name}</div>
              </div>
              <div className={styles.profile_phone}>
                <BsTelephoneInbound size={25} />
                <div>{userData.parent_phone}</div>
              </div>
              <div className={styles.profile_phone}>
        ...
        <div className={styles.edit__pro_box}>
          <div className={styles.edit__pro_abtMe}>
            ...
            >
              {userData.bio ? userData.bio : "Bio Not Added"}
              {/* {profile.about ? (
              profile.about
            ) : (
      ...
      <EditStudentProfileModal open={open} handleClose={handleClose} />
    </>
  );
};
